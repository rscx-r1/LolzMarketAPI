...
namespace LolzMarketAPI
{
    public static class LolzMarketAPI
    {
        ...
        {
            var getResponse = await client.DeleteAsync(url);
        ...
        public static async Task<string> Add_Proxy(string proxyIp, int proxyPort, string proxyUser = null, string proxyPass = null, string proxyRow = null)
        {
            // Add single proxy or proxy list
            var values = new Dictionary<string, string> { };
            values.Add("proxy_ip", proxyIp);
            values.Add("proxy_port", proxyPort.ToString());
        ...
        public static async Task<string> Change_Settings(bool? disable_steam_guard = null, bool? user_allow_ask_discount = null,
                                                         ...
                                                         bool? hide_favourites = null)
        {
            ...
            if (user_allow_ask_discount != null) { values.Add("user_allow_ask_discount", user_allow_ask_discount.ToString()); }
        ...
        public static async Task<string> Delete_Item(int itemId, string reason)
        {
            ...
            return await Delete_request(String.Format("{0}market/{1}/delete?reason={2}", baseUrl, itemId, reason));
        }
                                                   ...
                                                   Dictionary<string, string> key_values = null, string currency = "rub")
        {
            ...
            return await Put_request(String.Format("{0}market/{1}/edit/", baseUrl, itemId));
        }
